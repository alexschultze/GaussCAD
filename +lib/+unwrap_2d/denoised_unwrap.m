...
gradient_x_unwrapped_phase = lib.unwrap_2d.phase_wrap(gradient_x_wrapped_phase); gradient_y_unwrapped_phase = lib.unwrap_2d.phase_wrap(gradient_y_wrapped_phase); % Implementation of Eq.(3) and (4) of Ref.[1].
...
denoised_gradient_x_unwrapped_phase = lib.unwrap_2d.TV_min(gradient_x_unwrapped_phase); denoised_gradient_y_unwrapped_phase = lib.unwrap_2d.TV_min(gradient_y_unwrapped_phase); % Applying TV-minimization algorithm to derivatives.
