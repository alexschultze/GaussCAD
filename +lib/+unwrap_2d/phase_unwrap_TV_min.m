...
unwrapped_phase_1st_mode = lib.unwrap_2d.denoised_unwrap(wrapped_phase);
%% Calculating rest mode
unwrapped_phase = unwrapped_phase_1st_mode;
number_of_iteration = 0;
while(1)
    phase_r = lib.unwrap_2d.phase_wrap(wrapped_phase - unwrapped_phase); % Residual wrapped phase.
    ...
    if (N < N_c)
        ...
        unwrapped_phase = unwrapped_phase + lib.unwrap_2d.denoised_unwrap(phase_r);
    end
